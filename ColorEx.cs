/// <summary>
///
/// http://www.pausedotnet.fr/wp-content/uploads/projects/colorhelper/sources/vs2008/ColorExtension.cs
///
/// </summary>
...
namespace System.Drawing
{
	...
	public struct HSLColor
	{
		...
		public HSLColor(float fHue, float fSaturation, float fLightness)
		{
			this.H = fHue;
			this.S = fSaturation;
			this.L = fLightness;
	...
	public static class ColorEx
	{
		...
		/// <returns></returns>
		public static Color FromHSV(this Color c, float h, float s, float v)
		{
			// Hue checking
			if (h < 0f) h = 0f;
		...
		{
			float varR = (float)c.R / 255f;
			float varG = (float)c.G / 255f;
			float varB = (float)c.B / 255f;
		...
		/// <returns></returns>
		public static Color FromHSL(this Color c, float h, float s, float l)
		{
				// Hue checking
				if (h < 0f) h = 0f;
				else if (h > 360f) h = 360f;
